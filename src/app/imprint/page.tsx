export default function Imprint() {
	return (
		<div className="mb-24">
			<h1 className="do-fall do-fall-4 text-display mb-12 text-5xl">
				Imprint / Privacy
			</h1>

			<div
				lang="de"
				className="do-fall do-fall-2 flex max-w-[84ch] flex-col gap-8 text-xs"
			>
				...
				<p>Umsatzsteuer-ID gemäß §27 a Umsatzsteuergesetz: DE292735289</p>
			...
			<div className="do-fall do-fall-7 text-display my-12">---</div>

			<div
				lang="en"
				className="do-fall do-fall-4 flex max-w-[84ch] flex-col gap-8 text-xs"
			>
				...
				<p>VAT ID according to §27 a of the Value Added Tax Act: DE292735289</p>
				...
				<p>
					...
					under § 7 Abs.1 TMG for our own content on these pages according to
					general laws. According to §§ 8 to 10 TMG, however, we as a service
					...
					information under general laws remain unaffected by this. However,
					liability in this regard is only possible from the point in time at
					which a specific infringement of the law becomes known. Upon
					notification of corresponding infringements, we will remove this
					content immediately.
				</p>
				...
				<p>
					...
					evidence of an infringement. Upon becoming aware of legal
				...
				<p>
					...
					ask for a corresponding notification. Upon becoming aware of legal
				...
				<p>
					...
					voluntary basis, as far as possible. These data will not be passed on
					to third parties without your express consent. We would like to point
					out that data transmission over the Internet (e.g., communication by
					...
					parties for sending unsolicited advertising and information materials
					...
					sending of advertising information, such as spam emails.
				</p>
			</div>
		</div>
	)
